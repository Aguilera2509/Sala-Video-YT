...
export default function Video_Youtube(){
    ...
    useEffect(() => {
        ...
        function SendingDetailsVideoToViewers(){
    ...
    }, [sessionStorageCode, sessionStorageHost, isMobile, sessionStorageUsername]);
